...
const tasks = [{ id: 'hero', title: 'Hero banner copy', status: { label: 'In progress', tone: 'info' as const }, assignee: { initials: 'SR', name: 'Sofia Reyes' }, priority: 'High' as const, due: 'Oct 3' }]
